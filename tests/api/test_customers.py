...
# NOTE: Customers tests use backend/backend/ module (separate from main backend/app/)
# These must be run in isolation: pytest tests/api/test_customers.py -v
# They cannot run alongside other API tests due to conflicting module paths.
import sys
from pathlib import Path
_customers_path = str(Path(__file__).resolve().parent.parent.parent / "backend" / "backend")
if _customers_path not in sys.path:
    sys.path.insert(0, _customers_path)
